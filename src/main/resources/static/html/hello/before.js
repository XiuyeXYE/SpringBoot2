...
function Ma(a) {
 ...
 do if (a) {
  ...
  if (!(c[14] | 0)) b = 0; else b = Ma(c[14] | 0) | 0;
  ia(36);
  a = c[8] | 0;
  if (a) do {
   if ((c[a + 76 >> 2] | 0) > -1) d = Ra(a) | 0; else d = 0;
   if ((c[a + 20 >> 2] | 0) >>> 0 > (c[a + 28 >> 2] | 0) >>> 0) b = _a(a) | 0 | b;
   if (d) Sa(a);
   a = c[a + 56 >> 2] | 0;
  } while ((a | 0) != 0);
  ra(36);
...
function Qa(b) {
 ...
 var d = 0, e = 0, f = 0, g = 0;
 f = c[13] | 0;
 if ((c[f + 76 >> 2] | 0) > -1) g = Ra(f) | 0; else g = 0;
 do if ((Na(b, f) | 0) < 0) d = 1; else {
...
var xa=[ib,Ua];var ya=[jb,Xa,Va,Wa];var za=[kb,$a];return{_free:bb,_main:Ja,_memset:db,_malloc:ab,_memcpy:eb,_fflush:Ma,___errno_location:Ka,runPostSets:cb,stackAlloc:Aa,stackSave:Ba,stackRestore:Ca,establishStackSpace:Da,setThrew:Ea,setTempRet0:Ha,getTempRet0:Ia,dynCall_ii:fb,dynCall_iiii:gb,dynCall_vi:hb}})
